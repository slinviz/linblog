---
title: "[转载]Apache Spark 内存管理详解"
#description: <descriptive text here>
date: 2021-03-04T11:50:08+08:00
draft: true
#toc: false
#image: ""
tags: []
...
{{< hint info >}}
本文是对原文[Apache Spark 内存管理详解](https://developer.ibm.com/zh/articles/ba-cn-apache-spark-memory-management/)的转载并做了部分排版修改，后续会加入一些自己的理解和补充。
{{< /hint >}}
...
![堆内和堆外内存示意图](bigdata/spark-storage-1.png)
...
**图 2 . 静态内存管理图示——堆内**
![静态内存管理图示——堆内](bigdata/spark-storage-2.png)
...
**图 3 . 静态内存管理图示——堆外**
![静态内存管理图示——堆外](bigdata/spark-storage-3.png)
...
![统一内存管理图示——堆内](bigdata/spark-storage-4.png)

**图 5 . 统一内存管理图示——堆外**
![统一内存管理图示——堆外](bigdata/spark-storage-5.png)
...
![动态占用机制图示](bigdata/spark-storage-6.png)
...
**图 7 . Storage 模块示意图**
![Storage 模块示意图](bigdata/spark-storage-7.png)
...
![Spark Unroll 示意图](bigdata/spark-storage-8.png)
